				...
				<tbody style="width:80%; overflow:auto;"> 
					 ...
					 if ( empty($resType)) 
					{
					 ...
					 else 
					 {
							...
							$resType = mysql_real_escape_string($resType);
						
								$query = mysql_query("SELECT ResidentID, FirstName, MiddleInitial, LastName, ResidentType FROM  GenericInfo WHERE ='$resType';");
