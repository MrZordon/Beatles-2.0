<div id="NewMemberModal8" class="reveal-modal" data-reveal>
					...
					<div class="row">
						<div class="large-10 columns"> 
								<label>Does the resident have plans to further their education?</label> 
										<input type="radio" name="continueEdYN" value="Yes" id="continueEdY">
											<label for="continueEdY">Yes</label> 
										<input type="radio" name="continueEdYN" value="No" id="continueEdN">
											<label for="continueEdN">No</label> 	
							</div> 
					</div>
					<div class="row"> 
						<div class="large-12 columns"> 
							<label>If yes, what are the plans for further education? <textarea id="futureEdu" name="futureEdu" placeholder="Future educational plans"></textarea> </label> 
						</div> 
					</div> 
		</form>
		...
		<div class="row">
				<div class="large-3 columns"> 
					<p><a href="#" data-reveal-id="NewMemberModal9" class="secondary button">Next</a></p>
				</div>
