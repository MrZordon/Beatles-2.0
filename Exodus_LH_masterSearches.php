...
<!-- Include header file -->
  		 ...
  		 <div class="row">
  		   	...
  		   	<div class="large-9 columns">
					<ul class="right button-group">
						...
						<li><a href="Exodus_LH_home.php" class="button" id="home">Home</a></li>
					</ul>
 		 </div>
 		 </div>
    <!-- End Header and Nav --> 
 		...
 		<!-- Start a panel -->
          <div class="large-12 columns">
            	<div class="radius panel">
							...
							<h3 id="searchResidentBar"> Select a Method to Search for a Lazarus House Resident:</h3>
 							...
 							<!--  List of links to search for a resident formatted to look like buttons stacked-->
								<div class="row collapse">
										...
										<left><div class="large-10 small-8 columns">
											  <a href="#" data-reveal-id="ModalSearchByTypeLH" onclick="$(document).foundation().foundation('reveal', 'start');" class="postfix button expand">Search Resident(s) By Resident Type</a>
										</div></left>
										<left><div class="large-10 small-8 columns">
    ...
    <!-- Start Content of ModalSearchByType -->
   	 	<?php
   				include('includes/searchResByType_LH.php')
   			?>
    ...
    <!-- Start Content of ModalSearchByStatus -->
    		<?php
   				include('includes/searchResByStatusLH.php')
   			?>
