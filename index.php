  ...
  <div class="row">
    ...
    <!-- End Header and Nav -->
      ...
      <div class="row">
          ...
          <div class="large-6 columns">
            ...
            <h3 class="show-for-small">Lazarus House Ministries<hr/></h3>
 
            <div class="panel">
              <h4 class="hide-for-small">Lazarus House Ministries<hr/></h4>
            <h5 class="subheader">This is the home page for your database access.  From this page you will be able to access everything you need about the residents of Lazarus House.
                                  If this is your first time using the application please use the tutorial for help.</h5>
            </div>
          ...
          <div class="row">
              <div class="large-6 small-6 columns">
                <div class="panel">
                  <h5>Tutorial</h5>
                <h6 class="subheader">How to use this specific page.</h6>
              ...
              <div class="large-6 small-6 columns">
                <div class="panel">
                  <h5>Log Out</h5>
                <h6 class="subheader">Log Out for resident integrity.</h6>
                <a href="#" class="small button" id="numero5">Log Out</a>
                </div>
              </div>
          </div>
      ...
      <!-- Search Bar -->
        ...
        <div class="row">
          ...
          <div class="large-12 columns">
            ...
            <h3 id="firstStop"> Search For A Resident of Lazarus House</h3>
      ...
      <!-- Thumbnails -->
        ...
        <div class="row">
          ...
          <div class="large-3 small-6 columns">
            ...
            <div id="numero2" class="panel">
              <p>Add A Resident</p>
            </div>
          </div>
 
          <div class="large-3 small-6 columns">
            <img id="numero3" src="img/editIcon.png" >
            <div class="panel">
              <p>Edit A Resident's Info</p>
            </div>
          </div>
 
          <div class="large-3 small-6 columns">
            <a href="#" id="numero4"><img src="img/downloadIcon.png"></a>
            <div class="panel">
              <p>Backup Database</p>
            </div>
          </div>
   ...
   <!-- Joyride Code -->
    <ol class="joyride-list" data-joyride>
        ...
        <li data-id="numero2" data-class="custom so-awesome" data-options="tip_location: top data-text="Next">
            <h4>Stop #2</h4>
            <p>You can control all the details for you tour stop. Any valid HTML will work inside of Joyride.</p>
        </li>
        <li data-id="numero3" data-class="custom so-awesome" data-text="Next">
            <h4>Stop #3</h4>
            <p>You can control all the details for you tour stop. Any valid HTML will work inside of Joyride.</p>
        </li>
        <li data-id="numero4" data-class="custom so-awesome" data-options="tip_location: top data-text="Next">
            <h4>Stop #4</h4>
            <p>You can control all the details for you tour stop. Any valid HTML will work inside of Joyride.</p>
        </li>
        <li data-id="numero5" data-class="custom so-awesome" data-text="End">
            <h4>Stop #5</h4>
            <p>You can control all the details for you tour stop. Any valid HTML will work inside of Joyride.</p>
        </li>
